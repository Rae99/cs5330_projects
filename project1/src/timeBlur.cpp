/*
  ...
  This file is provided by the course instructor.
  No functional changes were made to the original implementation.
  The file is included and used as part of Project 1 for timing
  comparison of custom 5x5 blur implementations.
  ------------------------------------------------------------
*/
#include <cstdio>
#include <cstring>
